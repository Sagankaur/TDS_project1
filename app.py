...
app = FastAPI()
# uv run datagen.py 
# uv run datagen.py 23f2003511@ds.study.iitm.ac.in --root data
# uv run evaluate.py --email=23f2003511@ds.study.iitm.ac.in --log-level=INFO
...
#     # CUR_DIR = r"D:\IIT\tds\tds_1"  
#     # # file_path = os.path.join(CUR_DIR, path)  # Clean and join paths correctly
#     # if os.path.isabs(path):
#     #     path = os.path.relpath(path, start=os.path.abspath(CUR_DIR))
